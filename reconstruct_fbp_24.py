# -*- coding: utf-8 -*-
"""
3D Tomography Reconstruction and Post-Processing Tool v24 (Tkinter GUI)
(English Version: Auto-Start + Advanced Parameters + Clean UI)

================================================================================
Change Log (v24 Advanced Layout):
1. [GUI] Rearranged Parameter Frames:
   - "Filter Parameters" and "Advanced Parameters" are now side-by-side at the top.
   - Filter Parameters on the Left, Advanced Parameters on the Right.
2. [GUI] Updated grid layout for subsequent frames (Save, Control, Log).
================================================================================
"""
...
DEFAULT_CONFIG = {
    ...
    "PADDING_DIVISOR_EXPONENT": 8,  # k=8 (2^8 = 256)
...
class TomoPipeline:
    ...
    def run(self, input_dir: str) -> bool:
        ...
        print("--- Starting 3D Reconstruction and Post-Processing Task (v24 Adv) ---\n")
    ...
    def _apply_fft_filter(self) -> bool:
        ...
        1. Single-Side Mirror Padding (Left):
           - Formula: floor( (Original Width / 2^k) * 2^n ).
        ...
        padding_divisor_exponent = self.config.get("PADDING_DIVISOR_EXPONENT", 8.0)
        butterworth_order = self.config.get("BUTTERWORTH_ORDER", 2)

        power_of_2_cutoff = 2.0 ** cutoff_exponent
        padding_divisor = 2.0 ** padding_divisor_exponent
        ...
        if CUPY_AVAILABLE:
            try:
                ...
                # --- Advanced Padding Logic ---
                # Formula: floor( (Original Width / Divisor) * Cutoff_2^n )
                pad_width = int((cols_orig / padding_divisor) * power_of_2_cutoff)
                ...
                print(
                    f"FFT Config -> T:{tolerance}, Sigma:{sigma:.2f}, n:{cutoff_exponent}, k:{padding_divisor_exponent}, Order:{butterworth_order}")
        ...
        if not CUPY_AVAILABLE or use_cpu_fallback:
            ...
            print(
                f"FFT Config (CPU) -> T:{tolerance}, Sigma:{sigma:.2f}, n:{cutoff_exponent}, k:{padding_divisor_exponent}, Pad:{pad_width}, Cutoff:{cutoff_threshold:.2f}")
...
class App(tk.Tk):
    def __init__(self, defaults: Dict[str, Any]):
        ...
        self.title("3D Tomography Reconstruction Tool v24 Adv")
    ...
    def _create_widgets(self):
        ...
        adv_defs = {
            ...
            "PADDING_DIVISOR_EXPONENT": "Padding Divisor Order:"
        }
